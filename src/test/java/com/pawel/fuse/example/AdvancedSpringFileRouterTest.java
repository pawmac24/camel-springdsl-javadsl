...
public class AdvancedSpringFileRouterTest extends CamelSpringTestSupport {
    ...
    protected AbstractXmlApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext(new String[]{"file-spring-prod.xml", "file-spring-test.xml"});
    }
